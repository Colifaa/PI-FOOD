...
router.post("/", async(req,res) => {
    ...
    try {
        ...
        const typediet = await TypeDiet.findAll({    //FINDALL: consulta que recuperará todas las entradas de la tabla ( a menos que esté restringida por algo como un where cláusula, por ejemplo ).
            where: {name: diets}
        });
